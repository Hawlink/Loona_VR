...
public class OVRGrabbable : MonoBehaviour
{
	...
	virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
	    ...
	    //Send to PlayerController object
	    SendMessageUpwards("OnGrabBegin",this);
	    m_grabbedBy = hand;
        m_grabbedCollider = grabPoint;
        gameObject.GetComponent<Rigidbody>().isKinematic = true;
        gameObject.transform.position = hand.transform.position; // So the object is correctly centred in the hand
	...
	{
	    //m_grabbedBy.transform.parent.parent.parent.SendMessage("OnGrabEnd");
	   

        Rigidbody rb = gameObject.GetComponent<Rigidbody>();
        //rb.isKinematic = m_grabbedKinematic;
        rb.isKinematic = false; //In your app, objects grabbed will never be kinematic
        rb.velocity = linearVelocity;
        rb.angularVelocity = angularVelocity;

        //Tell the "Game" component that object is dropped
        m_grabbedBy.transform.SendMessageUpwards("OnGrabEnd");
